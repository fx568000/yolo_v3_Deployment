...
tf.app.flags.DEFINE_string(
    'input_img', 'data/messi.jpg', 'Input image')
tf.app.flags.DEFINE_string(
    'output_img', 'output/Result.jpg', 'Output image')
tf.app.flags.DEFINE_string(
...
tf.app.flags.DEFINE_string(
    'frozen_model', 'models/pb/frozen_darknet_yolov3_model.pb', 'Frozen tensorflow protobuf model')
